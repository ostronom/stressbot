...
func (dst *UserOutPeer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserOutPeer.Merge(dst, src)
}
...
func (dst *GroupOutPeer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GroupOutPeer.Merge(dst, src)
}
