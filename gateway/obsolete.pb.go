...
func (ObsoleteTypingType) EnumDescriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (ObsoleteWeakUpdateBox_ObsoleteUpdateCallDisposed_ObsoleteDisposalReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 9, 0}
}
...
func (*ObsoletePeer) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*ObsoleteOutPeer) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*ObsoletePeersList) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func (*ObsoleteGetDifferenceCommand) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }
...
func (*ObsoleteSeqUpdateBox) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{4} }
...
func (*ObsoleteWeakUpdateBox) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{5} }
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateUserLastSeen) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 1}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateGroupOnline) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 2}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateEventBusMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 3}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateEventBusDeviceConnected) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 4}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateEventBusDeviceDisconnected) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 5}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateEventBusDisposed) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 6}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateIncomingCall) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 7}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateCallHandled) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 8}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateCallDisposed) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 9}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateForceReloadState) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 10}
}
...
func (*ObsoleteWeakUpdateBox_ObsoleteUpdateForceReloadState_ObsoleteForceReloadField) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{5, 10, 0}
}
...
func (*ObsoleteServiceUpdate) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{6} }
...
func (*ObsoleteWeakUpdateCommand) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{7} }
...
func (*ObsoleteWeakUpdateCommand_ObsoleteMyOnline) Descriptor() ([]byte, []int) {
	return fileDescriptor13, []int{7, 1}
}
...
func init() { proto.RegisterFile("obsolete.proto", fileDescriptor13) }
