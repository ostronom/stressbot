...
func (*RequestRegisterDevice) Descriptor() ([]byte, []int) {
	return fileDescriptor_registration_8df75b18a6e344a8, []int{0}
}
...
func (*ResponseDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_registration_8df75b18a6e344a8, []int{1}
}
...
func (*RegisterDeprecatedDeviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_registration_8df75b18a6e344a8, []int{2}
}
...
func (*RequestExchangeAuthIdForToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_registration_8df75b18a6e344a8, []int{3}
}
...
func init() { proto.RegisterFile("registration.proto", fileDescriptor_registration_8df75b18a6e344a8) }

var fileDescriptor_registration_8df75b18a6e344a8 = []byte{
