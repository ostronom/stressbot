...
func (dst *UnreadDialog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnreadDialog.Merge(dst, src)
}
...
func (dst *AppCounters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AppCounters.Merge(dst, src)
}
...
func (dst *UpdateCountersChanged) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateCountersChanged.Merge(dst, src)
}
