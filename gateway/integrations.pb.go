...
func (*ResponseIntegrationToken) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*RequestGetIntegrationToken) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*RequestRevokeIntegrationToken) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func init() { proto.RegisterFile("integrations.proto", fileDescriptor9) }
