...
func (dst *ResponseIntegrationToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseIntegrationToken.Merge(dst, src)
}
...
func (dst *RequestGetIntegrationToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestGetIntegrationToken.Merge(dst, src)
}
...
func (dst *RequestRevokeIntegrationToken) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestRevokeIntegrationToken.Merge(dst, src)
}
