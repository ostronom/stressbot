...
func (*RequestBlockUser) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func (*RequestUnblockUser) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{1} }
...
func (*RequestLoadBlockedUsers) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{2} }
...
func (*ResponseLoadBlockedUsers) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{3} }
...
func (*UpdateUserBlocked) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{4} }
...
func (*UpdateUserUnblocked) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{5} }
...
func init() { proto.RegisterFile("privacy.proto", fileDescriptor15) }
