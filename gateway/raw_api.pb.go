...
func (dst *RequestRawRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestRawRequest.Merge(dst, src)
}
...
func (dst *ResponseRawRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseRawRequest.Merge(dst, src)
}
