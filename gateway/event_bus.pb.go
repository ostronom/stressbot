...
func (dst *RequestJoinEventBus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestJoinEventBus.Merge(dst, src)
}
...
func (dst *ResponseJoinEventBus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseJoinEventBus.Merge(dst, src)
}
...
func (dst *RequestKeepAliveEventBus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestKeepAliveEventBus.Merge(dst, src)
}
...
func (dst *RequestPostToEventBus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestPostToEventBus.Merge(dst, src)
}
...
func (dst *UpdateEventBusDeviceConnected) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateEventBusDeviceConnected.Merge(dst, src)
}
...
func (dst *UpdateEventBusDeviceDisconnected) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateEventBusDeviceDisconnected.Merge(dst, src)
}
...
func (dst *UpdateEventBusMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateEventBusMessage.Merge(dst, src)
}
...
func (dst *UpdateEventBusDisposed) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateEventBusDisposed.Merge(dst, src)
}
