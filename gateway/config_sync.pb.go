...
func (dst *RequestGetParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestGetParameters.Merge(dst, src)
}
...
func (dst *ResponseGetParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseGetParameters.Merge(dst, src)
}
...
func (dst *RequestEditParameter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestEditParameter.Merge(dst, src)
}
...
func (dst *UpdateParameterChanged) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateParameterChanged.Merge(dst, src)
}
