...
func (TypingType) EnumDescriptor() ([]byte, []int) { return fileDescriptor24, []int{0} }
...
func (DeviceType) EnumDescriptor() ([]byte, []int) { return fileDescriptor24, []int{1} }
...
func (*RequestTyping) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{0} }
...
func (*RequestStopTyping) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{1} }
...
func (*RequestSetOnline) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{2} }
...
func (*UpdatePauseNotifications) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{3} }
...
func (*UpdateRestoreNotifications) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{4} }
...
func (*RequestPauseNotifications) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{5} }
...
func (*RequestRestoreNotifications) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{6} }
...
func (*UpdateTyping) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{7} }
...
func (*UpdateTypingStop) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{8} }
...
func (*UpdateUserOnline) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{9} }
...
func (*UpdateUserOffline) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{10} }
...
func (*UpdateUserLastSeen) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{11} }
...
func (*UpdateGroupOnline) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{12} }
...
func init() { proto.RegisterFile("typing_and_online.proto", fileDescriptor24) }
